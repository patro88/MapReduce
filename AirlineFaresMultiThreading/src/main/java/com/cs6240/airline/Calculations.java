...
public class Calculations {
	...
	/*
	 * This method calculates fast median for a airline for a month 
	 * Algorithm used is quicksort with median of medians calculation to reduce the worst case 
	 * Returns output in a map : (airline month , median)
	 */
	public static Double calculateFastMedian(List<Double> priceList){

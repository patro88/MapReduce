 ...
 *           iv.  Prints the K, F and flight details in the console.// TODO: Add csv write functionality 
 */	
import java.io.File;
...
public class SingleThreadedJob {
	...
	private static Set<String> flightsActiveIn2015 = new HashSet<String>();
	/*
	...
	public Map<String, String> readAllFilesInFolder(final File folder, String oper) throws InterruptedException, ExecutionException {
		for (final File fileEntry : folder.listFiles()) {
			...
			Map<String, List<Double>> retunedValues = a1.call();
